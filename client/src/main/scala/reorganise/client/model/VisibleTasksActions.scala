...
case class UpdateTask (task: ClientTask) extends VisibleTasksAction
case class DeleteTask (task: ClientTask) extends VisibleTasksAction
...
case class ChangeView (newView: Option[ClientTasksView]) extends VisibleTasksAction
